...
#ifdef YOTTA_CFG_SUPPORT_DELAYED_RESPONSE
#define SUPPORT_DELAYED_RESPONSE YOTTA_CFG_SUPPORT_DELAYED_RESPONSE
#elif defined MBED_CONF_MBED_CLIENT_SUPPORT_DELAYED_RESPONSE
#define SUPPORT_DELAYED_RESPONSE MBED_CONF_MBED_CLIENT_SUPPORT_DELAYED_RESPONSE
#endif
