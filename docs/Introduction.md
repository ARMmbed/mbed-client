...
- [Client Registration and Deregistration](/docs/restructure/legacy-products/features.html#the-client-registration-feature)
- [Device Management and Service Enablement](/docs/restructure/legacy-products/features.html#the-device-management-and-service-enabler-feature)
- [Information Reporting](/docs/restructure/legacy-products/features.html#the-information-reporting-feature)
...
For transferring larger amounts of data, the Blockwise feature must be deployed. When using this feature, mbed Client can handle messages up to 65KB by default. This feature is disabled by default. To receive more than 65KB, see [Setting an external handler for block-wise messages](/docs/restructure/legacy-products/using-mbed-client-api.html#creating-and-configuring-resources-and-resource-instances).
...
More information on how to use the API effectively to [create and configure Objects, Object Instances and Resources](/docs/restructure/legacy-products/using-mbed-client-api.html).
