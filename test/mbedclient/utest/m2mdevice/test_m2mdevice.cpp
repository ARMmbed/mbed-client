...
void Test_M2MDevice::test_create_resource_string()
{
    ...
    CHECK(device->create_resource(M2MDevice::Manufacturer,max_length) == NULL);
    CHECK(M2MBase::GET_ALLOWED == m2mbase_stub::operation);
    ...
    CHECK(device->create_resource(M2MDevice::DeviceType,max_length) == NULL);

    CHECK(device->create_resource(M2MDevice::ModelNumber,"test") != NULL);
    CHECK(M2MBase::GET_ALLOWED == m2mbase_stub::operation);
    CHECK(device->create_resource(M2MDevice::ModelNumber,max_length) == NULL);


    CHECK(device->create_resource(M2MDevice::SerialNumber,"test") != NULL);
    CHECK(M2MBase::GET_ALLOWED == m2mbase_stub::operation);
    CHECK(device->create_resource(M2MDevice::SerialNumber,max_length) == NULL);


    CHECK(device->create_resource(M2MDevice::HardwareVersion,"test") != NULL);
    CHECK(M2MBase::GET_ALLOWED == m2mbase_stub::operation);
    CHECK(device->create_resource(M2MDevice::HardwareVersion,max_length) == NULL);


    CHECK(device->create_resource(M2MDevice::FirmwareVersion,"test") != NULL);
    CHECK(M2MBase::GET_ALLOWED == m2mbase_stub::operation);
    CHECK(device->create_resource(M2MDevice::FirmwareVersion,max_length) == NULL);


    CHECK(device->create_resource(M2MDevice::SoftwareVersion,"test") != NULL);
    CHECK(M2MBase::GET_ALLOWED == m2mbase_stub::operation);
    CHECK(device->create_resource(M2MDevice::SoftwareVersion,max_length) == NULL);


    CHECK(device->create_resource(M2MDevice::UTCOffset,"test") != NULL);
    CHECK(M2MBase::GET_PUT_ALLOWED == m2mbase_stub::operation);
    CHECK(device->create_resource(M2MDevice::UTCOffset,max_length) == NULL);


    CHECK(device->create_resource(M2MDevice::Timezone,"test") != NULL);
    CHECK(M2MBase::GET_PUT_ALLOWED == m2mbase_stub::operation);
    CHECK(device->create_resource(M2MDevice::Timezone,max_length) == NULL);
...
void Test_M2MDevice::test_set_resource_value_string()
{
    ...
    CHECK(device->set_resource_value(M2MDevice::Manufacturer,max_length) == false);
    CHECK(device->set_resource_value(M2MDevice::DeviceType,"test") == true);
    CHECK(device->set_resource_value(M2MDevice::DeviceType,max_length) == false);
    CHECK(device->set_resource_value(M2MDevice::ModelNumber,"test") == true);
    CHECK(device->set_resource_value(M2MDevice::ModelNumber,max_length) == false);
    CHECK(device->set_resource_value(M2MDevice::SerialNumber,"test") == true);
    CHECK(device->set_resource_value(M2MDevice::SerialNumber,max_length) == false);
    CHECK(device->set_resource_value(M2MDevice::HardwareVersion,"test") == true);
    CHECK(device->set_resource_value(M2MDevice::HardwareVersion,max_length) == false);
    CHECK(device->set_resource_value(M2MDevice::FirmwareVersion,"test") == true);
    CHECK(device->set_resource_value(M2MDevice::FirmwareVersion,max_length) == false);
    CHECK(device->set_resource_value(M2MDevice::SoftwareVersion,"test") == true);
    CHECK(device->set_resource_value(M2MDevice::SoftwareVersion,max_length) == false);
    CHECK(device->set_resource_value(M2MDevice::UTCOffset,"test") == true);
    CHECK(device->set_resource_value(M2MDevice::UTCOffset,max_length) == false);
    CHECK(device->set_resource_value(M2MDevice::Timezone,"test") == true);
    CHECK(device->set_resource_value(M2MDevice::Timezone,max_length) == false);
